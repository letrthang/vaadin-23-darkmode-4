...
@Tag("master-detail-java-view")
@JsModule("./views/masterdetailjava/master-detail-java-view.ts")
@Uses(Icon.class)
public class MasterDetailJavaView extends LitTemplate implements HasStyle, BeforeEnterObserver {
